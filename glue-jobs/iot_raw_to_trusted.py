...
# This version matches IoT data to customer data based on serial number (since this is lacking in accelerometer fields).
# This however limits IoT data to only that generated by the 30 repeating serialnumbers, and is thus incomplete.
